...
const Auth = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (loginData.email && loginData.password) {
      login({ email: loginData.email, name: loginData.email.split('@')[0] });
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F7F7] to-[#6FD3C8]/20 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#0F5E63] mb-2">
            Bienvenido a Ambulancia Deseo
          </h1>
          <p className="text-[#7A7A7A]">
            Regístrate o inicia sesión para comenzar a cumplir sueños
          </p>
        </div>
